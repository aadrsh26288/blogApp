...
const Register = () => {
  ...
  return (
    <>
      <div className="text-[#6EEB83] flex flex-col items-center justify-center text-center">
        <p className="text-[40px] dm">Welcome</p>
        <p className="text-[20px] lex text-white">let's sign up quickly</p>
      </div>
